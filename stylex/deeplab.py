...
def resnet101(pretrained=False, num_groups=None, weight_std=False, **kwargs):
    ...
    if pretrained:
        ...
        if num_groups and weight_std:
            pretrained_dict = torch.load('../../../input/trained-classifiers/trained_classifiers/R-101-GN-WS.pth.tar', map_location=torch.device("cpu"))
            # pretrained_dict = pretrained_dict.to(device)
